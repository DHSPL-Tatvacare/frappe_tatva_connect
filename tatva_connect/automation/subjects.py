...
This map is the single source of truth for: the watch-allowlist doctype gate (a can_watch row must name
a subject), the drift gate's doctype list, and `watch._subject`'s Lead resolution. No parallel list.
"""
