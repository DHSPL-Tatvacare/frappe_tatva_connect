...
def _assert_engine_wired():
	...
	if "tatva_connect.workflow_engine.triggers.on_created" not in created:
		frappe.throw('Automation drift: the Flow engine\'s on_created is not wired in hooks.doc_events["*"]["after_insert"].')
