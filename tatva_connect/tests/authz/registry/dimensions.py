...
DIMENSIONS = {
	...
	"role": ["sales_user", "sales_manager", "whatsapp_user", "whatsapp_admin",
	         "partner", "no_role", "default_user", "system_manager", "guest", "combo", "cross_app_junk"],
	...
	# other_owner = an object owned by a DIFFERENT user/tenant (object-level / IDOR target, not grain).
	"target_row": ["in_grain", "out_of_grain", "same_program_diff_vertical",
	               "orphan_parent", "wildcard", "other_owner", "na"],
	"action": ["read", "write", "create", "delete", "field_read", "list", "info"],
