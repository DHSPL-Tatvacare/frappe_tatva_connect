...
subject of this test is our API, not LSQ's S3.
    ...
    python -m tatva_connect.tests.loadtest.files anaya --leads 20
    python -m tatva_connect.tests.loadtest.files anaya --leads 20 --no-clamav
"""
import argparse
import base64
import json
...
from tatva_connect.tests.loadtest.client import Partner
from tatva_connect.tests.loadtest.config import REPORTS, lsq_creds, partner_token
