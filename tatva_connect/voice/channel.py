...
Separate from `Task::Automation::sends` on purpose: that switch governs whether the ENGINE sends at all,
...
def reconciler_enabled() -> bool:
	...
	return settings.is_enabled(SWITCH_RECONCILER)
